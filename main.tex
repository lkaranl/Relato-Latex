...
\titlespacing*{\section}{0pt}{1.5ex}{0pt} % Corpo do texto inicia imediatamente abaixo (0pt)
...
\newenvironment{citacaolonga}
  {\begin{list}{}{
    \footnotesize % Tamanho 10 (footnotesize em doc 12pt)
    \singlespacing
    \leftmargin=4cm
    \rightmargin=0pt}
    \item\relax}
...
\begin{center}
    ...
    \footnotesize % Notas/Fontes em tamanho 10 [cite: 96]
